...
func main() {
	...
	// knowledge nugget: If you follow the documentation,
	//you will notice that awscdk.App embeds awscdk.Stage which in turn embeds constructs.Construct.
...
func env() *awscdk.Environment {
	...
	return &awscdk.Environment{
	 Account: jsii.String("465743759656"),
